...
from Lightning_Model_NoDP import DPSequenceClassifier, TimeMemoryCallback
...
print(df)
filename = f"{config['fttype']}_{trainer.current_epoch}.csv"
df.to_csv(f'./Non_DP_Tests/{filename}', index=True)
